...
CRNN_CONF_THRESHOLD = 0.70   # SRS REC-005: below this -> REVIEW_REQUIRED
    ...
    def process_image(self, image_path) -> dict:
        ...
        try:
            ...
            for i, det in enumerate(detections):
                ...
                plate_text, crnn_conf = self.reader.read(det["crop"])
                ...
                if crnn_conf < CRNN_CONF_THRESHOLD:
                ...
                self.db.log_read(
                    ...
                    crnn_confidence=crnn_conf, action=action,
                    plate_text=(plate_text if action == "ENTRY_ALLOWED" else None),
                ...
                key = {"ENTRY_ALLOWED": "allowed", "ENTRY_DENIED": "denied",
                       "REVIEW_REQUIRED": "review"}.get(action, "denied")
                self._session[key] = self._session.get(key, 0) + 1
